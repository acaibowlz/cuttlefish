...
It has the building blocks you'd expect from a static site generator — content types, taxonomies, templates — and one deliberate omission: there's no theme to install, no CSS framework, and no build step for your CSS or JS. Your whole site is a handful of plain-text files and one stylesheet you never open by hand.
