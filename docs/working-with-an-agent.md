...
- **Layout.** The home page is assembled from sections you control — recent items per type, taxonomy term lists — and every listing and single-page template is yours to restructure. "Group blog posts by year" or "show tags as a cloud on the home page" are template changes.
